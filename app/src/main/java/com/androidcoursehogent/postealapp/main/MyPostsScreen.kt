...
data class PostRow(
    ...
    fun add(post: PostData) {
        if (post1 == null) post1 = post
        else if (post2 == null) post2 = post
        else if (post3 == null) post3 = post
    }
}

@Composable
fun MyPostsScreen(navController: NavController, vm: PostealappViewModel) {
    ...
    var postsLoading = vm.refreshPostsProgress.value
